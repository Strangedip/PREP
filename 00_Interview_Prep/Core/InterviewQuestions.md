...
> **You are here**: Senior SDE / Tech Lead — Interview Prep (cram sheet)
> **Roadmap**: [Developer Master Roadmap](../../ROADMAP.md) | **Prerequisites**: [SelfAssessment](SelfAssessment.md) | **Next**: [Interview Playbook](InterviewPlaybook.md)
