...
> **You are here**: All levels — Interview Prep (diagnostic)
> **Roadmap**: [Developer Master Roadmap](../../ROADMAP.md) | **Prerequisites**: [ROADMAP — your level](../../ROADMAP.md#the-ladder-scope-authority-all-levels) | **Next**: [Interview Playbook](InterviewPlaybook.md)
...
> **Career ladder**: [ROADMAP.md](../../ROADMAP.md)
>
