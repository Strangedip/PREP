...
| **OA / screening** | After shortlist | [StudyGuide Path 1](../../02_DSA/StudyGuide.md) Easy problems daily |
...
**Next**: [Interview Playbook](../Core/InterviewPlaybook.md) when you have scheduled screens.
